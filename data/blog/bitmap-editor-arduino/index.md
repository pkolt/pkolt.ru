...
![Метеостанция на Arduino Nano](./weather_station.jpg)
...
![Редактирование изображения](./dinosaur_editor_ru.png)
...
![Динозавр на экране SSD1306](./dinosaur.jpg)
...
![Создание bitmap из изображения](./mickey_mouse_editor_ru.png)

После загрузки изображения на Arduino вы увидите на экране:

![Микки Маус на экране SSD1306](./mickey_mouse.jpg)
...
![Подключение SSD1306 к Arduino](./arduino_ssd1306.png)
...
![Экспорт bitmap](./arduino_editor_1_ru.png)
...
![Настройка экспорта](./arduino_editor_2_ru.png)
...
![Ардуино на экране SSD1306](./arduino.jpg)
...
![Символы шрифта](./font_numbers.png)
...
![Иконки шрифта](./font_icons_ru.png)

Отображение данных на дисплее метеостанции:

![Отображение погоды](./weather_station_display.jpg)
