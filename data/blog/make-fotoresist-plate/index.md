...
![Набор компонентов](./article_01.jpg)
...
![EasyEDA экспорт платы](./easy_eda_02.png)
...
![Объединение двух pdf файлов](./merge_pdf_01.png)

Теперь в нашем PDF-файле две страницы с печатной платой и паяльной маской.

![Результат объединения двух pdf файлов](./merge_pdf_02.png)
...
![Печать на одном листе A4](./adobe_acrobat.png)
...
![Фоторезист на плате](./fotorezist_in_plate.jpg)
...
![Засветка фоторезиста](./uf_fotorezist.jpg)
...
![Проявка фоторезиста](./soda_01.jpg)
...
![Травление платы](./travlenie_01.jpg)
...
![Травление платы](./travlenie_02.jpg)

По готовности, промываем плату в воде, раствор выливаем в унитаз.

![Травление платы](./travlenie_03.jpg)
...
![Смываем фоторезист](./fotoresist_01.jpg)
...
![Фиксируем плату скотчем](./mask_01.jpg)
...
![Карточкой удаляем излишки маски](./mask_04.jpg)
...
![Фотошаблон поверх маски](./mask_05.jpg)
...
![Засвечиваем маску лампой](./mask_06.jpg)
...
![Снимаем пленку с платы](./mask_07.jpg)
...
![Стираем маску на контактах](./mask_08.jpg)

Отправляем плату на закрепляющее застывание под УФ-лампой на 30 минут.

![Финальная засвечивание платы](./mask_09.jpg)
