...
Давайте рассмотрим один из принципов SOLID (см. книгу "Чистая архитектура", Роберт Мартин) - принцип открытости-закрытости (Open-Closed Principle) в контексте современных приложений React.
...
3. Тестирование становится сложнее с каждым изменением.
...
```tsx
// Добавление нового варианта без изменения базового компонента
...
1. **Используйте композицию вместо модификации** — расширяйте компоненты с помощью props и render props;
