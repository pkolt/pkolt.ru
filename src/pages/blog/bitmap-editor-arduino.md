...
Перейдите на [страницу редактора](https://pkolt.github.io/bitmap_editor/). 
...
Перейдите на [главную страницу приложения](https://pkolt.github.io/bitmap_editor/) и нажмите кнопку «Импортировать» → «Из коллекции».
...
Для этого зайдите на [главную страницу приложения](https://pkolt.github.io/bitmap_editor/) и нажмите на иконку с дискетой у нужного элемента списка.
...
[Редактор bitmap-картинок](https://github.com/pkolt/bitmap_editor) помог мне завершить проект метеостанции на Arduino.
