...
- **DC-DC преобразователь** (600mA, input 3-15V, output 3.3V). Импульсный преобразователь, который будет понижать ток с солнечных панелей (5V), до 3.3V и заряжать ионистор. Самое главное не подать на ионистор ток выше 3.8V, это приведет к его повреждению.
