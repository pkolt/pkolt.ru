...
// const getPostBySlug = (slug: string, opts: { content?: boolean } = {}): PostMarkdown | null => {
...
// export const getPostList = (): PostMarkdown[] => {
