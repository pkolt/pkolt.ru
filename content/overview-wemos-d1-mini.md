...
1) Через microUSB. Ток проходит через встроенный регулятор 4B2X [(Torex XC6204B33)](https://www.torexsemi.com/file/xc6205/XC6204-XC6205.pdf) и понижается до рабочего 3.3 V .

2) Через контакты **5V** и **GND**. Можно запитать током в диапазоне 2-10 V, встроенный регулятор 4B2X (Torex XC6204B33) понизит напряжение до рабочего 3.3 V .
